                                ...
                                <img src="${item.image}" class="card-img-top" alt="product">
                                  ...
                                  <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                      <div class="btn-group">
                                        <button type="button" class="btn-add-to-cart" data-id=${item.id}><i>Add to card</i></button>
...
//search filter
searchFilter(){
    document.querySelector('#text-search').addEventListener('input',filterList);

    function filterList(){
        const searchInput=document.querySelector('#text-search');
        const filter = searchInput.value.toLowerCase();
        const listItems = document.querySelectorAll('#products-dom');
...
//search buttons
ButtonsFilter(){
    buttonsDOM = buttonCategory;
    buttonCategory.forEach(function(btn){
    btn.addEventListener('click',function(e){
    let category= e.currentTarget.dataset.id;
    let productCategory=cart.filter(function(item){
    ...
    if(category==='all'){
        ...
        displayProducts(buttonCategory);
    }
});
